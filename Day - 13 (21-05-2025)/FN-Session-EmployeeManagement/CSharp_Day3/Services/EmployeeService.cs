...
using CSharp_Day3.Interfaces;
using CSharp_Day3.Models;

namespace CSharp_Day3.Services
{
    public class EmployeeService : IEmployeeService
    {
        ...
        public bool UpdateEmployee(Employee employees)
        {
            try
            {
                var updated = _employeeRepository.Update(employees);
                if (updated != null)
                {
                    return true;
                } else
